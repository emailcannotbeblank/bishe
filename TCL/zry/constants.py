...
# CheXpert constants
#CHEXPERT_DATA_DIR = Path("/public/home/ac3uk4mh70/zry/dataset/mimic-cxr-small")
CHEXPERT_DATA_DIR = Path("/home/zry/dataset/mimic-cxr-small/")
CHEXPERT_ORIGINAL_TRAIN_CSV = CHEXPERT_DATA_DIR / "mimic-jpg-train-valid-test.csv"
...
CHEXPERT_TEST_CSV = (
    CHEXPERT_DATA_DIR / "test_split.csv"
)  # using validation set as test set (test set label hidden)
CHEXPERT_MASTER_CSV = (
    CHEXPERT_DATA_DIR / "mimic-jpg-train-valid-test.csv"
...
CHEXPERT_VIEW_COL = "ViewPosition"
