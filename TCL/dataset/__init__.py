...
def create_dataset(dataset, config):
    ...
    if dataset=='pretrain':
        from zry.gloria_pretraining_dataset import MultimodalPretrainingDataset
        from omegaconf import OmegaConf 
        cfg = OmegaConf.load("configs/mimic-cxr.yaml") 
        dataset = MultimodalPretrainingDataset(cfg,split = "train", transform = pretrain_transform)
